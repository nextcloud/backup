OC.L10N.register(
    ...
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Un point de restauration entier sera créé {delayFullRestoringPoint} jours après le dernier n'importe quel jour de la semaine entre {timeSlotsStart} heure et {timeSlotsEnd} heure.",
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends." : "Un point de restauration complet sera créé {delayFullRestoringPoint} après le dernier pendant le week-end entre {timeSlotsStart} heure et {timeSlotsEnd} heure.",
    "A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Un point de restauration partiel sera créé {delayPartialRestoringPoint} jours après le dernier n'importe quel jour de la semaine entre {timeSlotsStart} heure and {timeSlotsEnd} heure.",

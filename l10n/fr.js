OC.L10N.register(
    ...
    "Path in which to store the data. (Ex: 'app_data')" : "Chemin dans lequel stocker les données. (P.ex. : 'app_data')",
    "Error" : "Erreur",
    ...
    "Schedule summary" : "Résumé de la planification",

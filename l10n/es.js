OC.L10N.register(
    ...
    "Choose where the backup app will initially store the restoring points." : "Elija dónde la aplicación de respaldo almacenará inicialmente los puntos de restauración.",
    ...
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._" : ["Un punto de restauración completo se creará {delayFullRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 en cualquier día de la semana.","Un punto de restauración completo se creará {delayFullRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 en cualquier día de la semana.","Un punto de restauración completo se creará {delayFullRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 en cualquier día de la semana."],
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._" : ["Un punto de restauración completo se creará {delayFullRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 durante el fin de semana.","Un punto de restauración completo se creará {delayFullRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 durante el fin de semana.","Un punto de restauración completo se creará {delayFullRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 durante el fin de semana."],
    "_A partial restoring point will be created {delayPartialRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._::_A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._" : ["Un punto de restauración parcial se creará {delayPartialRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 en cualquier día de la semana.","Un punto de restauración parcial se creará {delayPartialRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 en cualquier día de la semana.","Un punto de restauración parcial se creará {delayPartialRestoringPoint} días después del anterior entre las {timeSlotsStart}:00 y las {timeSlotsEnd}:00 en cualquier día de la semana."],

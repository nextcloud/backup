OC.L10N.register(
    ...
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._" : ["Um ponto de restauração completo será criado {delayFullRestoringPoint} dia após o último entre {timeSlotsStart}:00 e {timeSlotsEnd}:00 em qualquer dia da semana.","Um ponto de restauração completo será criado {delayFullRestoringPoint} dias após o último entre {timeSlotsStart}:00 e {timeSlotsEnd}:00 em qualquer dia da semana."],
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._" : ["Um ponto de restauração completo será criado {delayFullRestoringPoint} dia após o último entre {timeSlotsStart}:00 e {timeSlotsEnd}:00 durante os fins de semana.","Um ponto de restauração completo será criado durante {delayFullRestoringPoint} dias após o último entre {timeSlotsStart}:00 e {timeSlotsEnd}:00 os fins de semana."],

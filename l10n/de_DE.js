OC.L10N.register(
    ...
    "hours" : "Stunden",
    "days" : "Tage",
    "A new restoring point ({type}) have been generated, requiring maintenance mode for {downtime}." : "Es wurde ein neuer Wiederherstellungspunkt ( {type}) erzeugt, der den Wartungsmodus für {downtime} erfordert.",
    ...
    "Path in which to store the data. (Ex: 'app_data')" : "Pfad, unter dem die Daten gespeichert werden sollen. (Beispiel: \"app_data\")",
    ...
    "Path in which to store the restoring points. (Ex: 'backups')" : "Pfad, in dem die Wiederherstellungspunkte gespeichert werden sollen. (Bsp.: 'Sicherungen')",
    ...
    "and" : "und",
    "Allow to create full restoring points during week day" : "Ermöglicht die Erstellung vollständiger Wiederherstellungspunkte während des Wochentags",
    ...
    "The creation of a restoring point as been requested and will be initiated soon." : "Die Erstellung eines Wiederherstellungspunktes wurde angefordert und bald gestartet.",
    ...
    "I understand that the server will be put in maintenance mode." : "Ich verstehe, dass der Server in den Wartungsmodus versetzt wird.",

OC.L10N.register(
    ...
    "The file {file} have been restored based on a restoring point from {date} (estimated rewind: {rewind})" : "Die Datei {file} wurde basierend auf einem Wiederherstellungspunkt vom {date} wiederhergestellt (geschätzter Rücklauf: {rewind})",
    ...
    "I understand some data will be deleted." : "Mir ist bewusst, dass einige Daten gelöscht werden.",
    ...
    "Backups configuration" : "Backup Konfiguration",
    ...
    "Packing processing" : "Verpackungsverarbeitung",
    "Processing that will be done on the restoring points during the packing step." : "Bearbeitung, die an den Wiederherstellungspunkten während des Verpackungsschritts durchgeführt wird.",
    ...
    "Export backup configuration" : "Backup Konfiguration",
    ...
    "I understand that the server will be put in maintenance mode." : "Mir ist bewusst, dass der Server in den Wartungsmodus versetzt wird.",
    "Cancel" : "Abbrechen",

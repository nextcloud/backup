OC.L10N.register(
    ...
    "and" : "及",
    "Allow to create full restoring points during week day" : "允許在工作日創建完整還原點",
    ...
    "Enable restoring point packing" : "啟用還原點集裝",
    "Enable encryption" : "啟用加密",
    "Enable compression" : "啟用壓縮",
    "Restoring point history" : "還原點歷史",
    "Number of restoring points to keep during a purge:" : "清除期間要保留的還原點數目：",
    "In the local app data" : "在近端應用程式數據中",
    "In external storages" : "在外部儲存",
    "Schedule summary" : "時間表摘要",

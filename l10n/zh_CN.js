OC.L10N.register(
    ...
    "hours" : "小时",
    "days" : "天",
    "A new restoring point ({type}) have been generated, requiring maintenance mode for {downtime}." : "已创建了一个新还原点 ({type}），需要 {downtime} 时间的维护模式",
    ...
    "You can export your settings with the below button. The exported file is important as it allows you to restore your backup in case of full data lost. Keep it in a safe place!" : "您可以使用下面的按钮导出设置。导出的文件是重要的，因为它允许您在数据完全丢失的情况下恢复备份。把它放在安全的地方！",

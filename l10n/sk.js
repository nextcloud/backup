OC.L10N.register(
    ...
    "Create restoring points during the following time slot during the day:" : "Vytvoriť body obnovenia počas nasledujúceho časového úseku počas dňa:",
    "and" : "a",
    "Allow to create full restoring points during weekday" : "Umožniť vytvoriť úplné body obnovenia počas pracovného dňa",
    ...
    "Restoring point packing" : "Komprimácia bodu obnovenia",
    "Enable restoring point packing" : "Povoliť komprimáciu bodu obnovenia",
    "Enable encryption" : "Povoliť šifrovanie",
    "Enable compression" : "Povoliť komprimáciu",
    "Restoring point history" : "História bodu obnovenia",
    "Number of restoring points to keep during a purge:" : "Počet bodov obnovenia, ktoré sa majú zachovať počas čistenia:",
    ...
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Úplný bod obnovenia sa vytvorí {delayFullRestoringPoint} dní po poslednom bode medzi {timeSlotsStart}:00 a {timeSlotsEnd}:00 ktorýkoľvek deň v týždni.",
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends." : "Úplný bod obnovenia sa vytvorí {delayFullRestoringPoint} dní po poslednom bode medzi {timeSlotsStart}:00 a {timeSlotsEnd}:00 počas víkendov.",
    "A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Bod čiastočného obnovenia sa vytvorí {delayPartialRestoringPoint} dní po poslednom bode medzi {timeSlotsStart}:00 a {timeSlotsEnd}:00 ktorýkoľvek deň v týždni.",
    ...
    "Your settings export has been downloaded encrypted. To be able to decrypt it later, please keep the following private key in a safe place:" : "Export vašich nastavení bol stiahnutý zašifrovaný. Aby ste ho mohli neskôr dešifrovať, uschovajte si nasledujúci súkromný kľúč na bezpečnom mieste:",
    "Request the creation of a new restoring point now" : "Požiadajte o vytvorenie nového bodu obnovenia už teraz",
    "The creation of a restoring point has been requested and will be initiated soon." : "Vytvorenie bodu obnovenia bolo vyžiadané a čoskoro sa spustí.",

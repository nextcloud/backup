OC.L10N.register(
    ...
    "Path in which to store the restoring points. (Ex: 'backups')" : "Pfad, in dem die Wiederherstellungspunkte gespeichert werden sollen (z. B. 'Sicherungen')",

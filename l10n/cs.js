OC.L10N.register(
    ...
    "Unable to fetch external locations" : "Nedaří se získat externí umístění",
    ...
    "You can enable background task for backups. This means that the creation, maintenance and purges of backups will be done automatically." : "Ohledně zálohování je možné zapnout spouštění úloh na pozadí. To znamená, že vytváření, údržba a čištění záloh se bude dít automaticky.",
    ...
    "Maintenance: Restoring points will be packed and copied to potential external storages." : "Údržba: body obnovení budou zabaleny a zkopírovány na případná externí úložiště.",
    "Purge: Old restoring points will be deleted automatically according to the retention policy." : "Čistění: staré body obnovení budou automaticky mazány v souladu se zásadami ponechávání.",
    ...
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Úplný bod obnovení bude vytvořen po uplynutí {delayFullRestoringPoint} dnů od toho minulého v časovém okně {timeSlotsStart}:00 až {timeSlotsEnd}:00 kdykoli v týdnu.",
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends." : "Úplný bod obnovení bude vytvořen po uplynutí {delayFullRestoringPoint} dnů od toho minulého v časovém okně {timeSlotsStart}:00 až {timeSlotsEnd}:00 o víkendech.",
    "A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Částečný bod obnovení bude vytvořen po uplynutí {delayPartialRestoringPoint} dnů od toho minulého v časovém okně {timeSlotsStart}:00 a {timeSlotsEnd}:00 kdykoli v týdnu.",
    "Limit restoring points creation to the following hours interval:" : "Omezit vytváření bodů obnovení na následující časové okno:",
    "and" : "a",
    ...
    "You can export your settings with the below button. The exported file is important as it allows you to restore your backup in case of full data lost. Keep it in a safe place!" : "Pomocí tlačítka níže je možné exportovat nastavení. Exportovaný soubor je důležitý, protože umožňuje obnovit zálohu v případě kompletní ztráty dat. Uchovávejte ho bezpečně!",
    ...
    "Cancel" : "Storno",
    "Request {mode} restoring point" : "Vyžádat pořízení {mode} bod obnovení",

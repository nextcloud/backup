OC.L10N.register(
    ...
    "hours" : "uren",
    "days" : "dagen",
    "A new restoring point ({type}) have been generated, requiring maintenance mode for {downtime}." : "Een nieuw herstelpunt ({type}) is gegenereerd, hiervoor is de onderhoudsmodus {downtime} nodig.",
    ...
    "and" : "en",
    "Allow to create full restoring points during week day" : "Sta toe volledige herstelpunten te creëren op weekdag",
    ...
    "A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Een gedeeltelijk herstelpunt wordt gecreërd {delayPartialRestoringPoint} dagen na de laatste tussen {timeSlotsStart}:00 en {timeSlotsEnd}:00 elke dag van de week.",

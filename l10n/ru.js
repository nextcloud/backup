OC.L10N.register(
    ...
    "hours" : "часы",
    "days" : "дни",
    "A new restoring point ({type}) have been generated, requiring maintenance mode for {downtime}." : "Создана новая точка восстановления ({type}), требующая режима обслуживания на {downtime}.",
    ...
    "The Backup App creates and stores backup images of your Nextcloud:\n\n\t  - Backup the instance, its apps, your data and your database,\n      - Admin can configure the time slots for automated backup,\n      - Full and Partial backup, with different frequencies,\n      - 2-pass to limit downtime (maintenance mode) of your instance,\n      - compression and encryption,\n      - upload your encrypted backup on an external filesystem,\n      - download and search for your data,\n      - restore single file or the complete instance" : "Приложение резервного копирования создает и хранит образы резервных копий вашего Nextcloud:\n \n\t - Резервное копирование экземпляра, его приложений, ваших данных и вашей базы данных, \n- Администратор может настроить временные интервалы для автоматического резервного копирования, - Полное и частичное резервное копирование с различными частоты, \n- 2 прохода для ограничения времени простоя (режим обслуживания) вашего экземпляра, \n- сжатие и шифрование, \n- загрузка зашифрованной резервной копии во внешнюю файловую систему, \n- загрузка и поиск ваших данных, \n- восстановление одного файла или полный экземпляр",
    ...
    "Path in which to store the data. (Ex: 'app_data')" : "Путь для хранения данных. (Пример: 'app_data')",
    ...
    "Path in which to store the restoring points. (Ex: 'backups')" : "Путь для хранения точек восстановления. (Пример: «backups»)",
    ...
    "Create restoring points during the following time slot during the day:" : "Создайте точки восстановления в течение следующего временного интервала в течение дня:",
    "and" : "и",
    "Allow to create full restoring points during week day" : "Разрешить создавать точки полного восстановления в будний день",
    "Delay between two full restoring points" : "Задержка между двумя точками полного восстановления",
    "Delay between two partial restoring points" : "Задержка между двумя точками частичного восстановления",
    "Enable restoring point packing" : "Восстановление точки упаковки",
    ...
    "You can export your settings with the below button. The exported file is important as it allows you to restore your backup in case of full data lost. Keep it in a safe place!" : "Вы можете экспортировать свои настройки с помощью кнопки ниже. Экспортированный файл важен, поскольку он позволяет восстановить резервную копию в случае полной потери данных. Храните в надежном месте!",
    "Export configuration" : "Конфигурация экспорта",
    "Your settings export as been downloaded encrypted. To be able to decrypt it later, please keep the following private key in a safe place:" : "Ваши настройки экспортируются в зашифрованном виде. Чтобы потом расшифровать его, храните следующий закрытый ключ в надежном месте:",

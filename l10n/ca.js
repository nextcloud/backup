OC.L10N.register(
    ...
    "Update on all Backup's event" : "Actualització de tots els esdeveniments de Backup",
    "complete" : "complert",
    "partial" : "parcial",
    "seconds" : "segons",
    "minutes" : "minuts",
    ...
    "New external location added" : "Afegida nova localització externa afegida",
    ...
    "Enable background tasks" : "Activa les tasques en segon pla",
    ...
    "Creation: New restoring points will be created according to the schedule." : "Creació: Es crearan nous punts de restauració segons el calendari.",
    ...
    "Purge: Old restoring points will be deleted automatically according to the retention policy." : "Purga: els punts de restauració antics s'eliminaran automàticament d'acord amb la política de retenció.",
    ...
    "Backup schedule" : "Programació de còpies de seguretat",
    ...
    "Policy for the local app data" : "Política per a les dades de l'aplicació local",
    ...
    "You can export your settings with the below button. The exported file is important as it allows you to restore your backup in case of full data lost. Keep it in a safe place!" : "Podeu exportar la vostra configuració amb el botó següent. El fitxer exportat és important, ja que us permet restaurar la vostra còpia de seguretat en cas de pèrdua de dades completes. Guardeu-lo en un lloc segur!",
    "Export configuration" : "Exporta la configuració",
    "Your settings export as been downloaded encrypted. To be able to decrypt it later, please keep the following private key in a safe place:" : "La teva configuració s'exporta tal com s'ha baixat encriptada. Per poder desxifrar-lo més tard, manteniu la clau privada següent en un lloc segur:",
    ...
    "Unable to fetch the settings" : "No es pot recuperar la configuració",
    ...
    "Unable to export settings" : "No es pot exportar la configuració",

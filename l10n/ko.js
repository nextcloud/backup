OC.L10N.register(
    ...
    "hours" : "시",
    "days" : "일",
    "A new restoring point ({type}) has been generated, requiring maintenance mode for {downtime}." : "새로운 복원 포인트 ({type})가 생성됐으며, {downtime}동안 유지 모드를 요구합니다.",
    ...
    "Requesting a backup will put the server in maintenance mode." : "백업을 요청하면 서버가 유지 모드가 됩니다.",

OC.L10N.register(
    ...
    "complete" : "완성",
    "partial" : "일부분",
    "A new restoring point ({type}) has been generated, requiring maintenance mode for {downtime}." : "새로운 복원 포인트 ({종류})가 생성됐으며, {중단 시간} 동안 유지 모드를 요구합니다",
    "Your system have been fully restored based on a restoring point from {date} (estimated rewind: {rewind})" : "당신의 시스템은 {날짜}로부터의 복원 포인트를 기반으로 완전히 복원됐습니다 (추정 rewind: {rewind})",
    "The file {file} have been restored based on a restoring point from {date} (estimated rewind: {rewind})" : "파일 {파일}은 {날짜}로부터의 복원 포인트를 기반으로 완전히 복원됐습니다 (추정 rewind: {rewind})",
    "Backup now. Restore later." : "지금 백업하고, 복원은 나중에 하십시오",
    ...
    "App Data" : "앱 데이터",
    "Choose where the backup app will initially store the restoring points." : "백업 앱이 최초로 복원 포인트를 저장할 장소를 고르십시오",
    ...
    "Maintenance: Restoring points will be packed and copied to potential external storages." : "유지: 복원 포인트는 잠재적 외부 저장소로 포장되고 복사 될 것입니다.",
    ...
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "완전한 복원 포인트는 마지막으로 생성된 포인트의 수일{delayFullRestoringPoint} 뒤에 어느 요일이든 {timeSlotsStart}:00와 {timeSlotsEnd}:00 사이에 생성될 것입니다.",
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends." : "완전한 복원 포인트는 마지막으로 생성된 포인트의 수일{delayFullRestoringPoint} 뒤에 주말 {timeSlotsStart}:00와 {timeSlotsEnd}:00 사이에 생성될 것입니다.",
    "A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "부분적인 복원 포인트는 마지막으로 생성된 포인트의 수일{delayFullRestoringPoint} 뒤에 어느 요일이든 {timeSlotsStart}:00와 {timeSlotsEnd}:00 사이에 생성될 것입니다.",
    ...
    "Requesting a backup will put the server in maintenance mode." : "백업에 대한 요청은 서버를 유지 모드가 되도록 합니다",
    "I understand that the server will be put in maintenance mode." : "나는 서버가 유지 모드가 될 것을 알고 있다",

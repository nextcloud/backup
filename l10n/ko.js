OC.L10N.register(
    ...
    "Your settings export has been downloaded encrypted. To be able to decrypt it later, please keep the following private key in a safe place:" : "귀하의 설정 내보내기는 암호화된 상태로 다운로드 됩니다. 나중에 복호화하기 위해서는, 다음의 비밀 키를 안전한 곳에 보관하세요:",
    "Request the creation of a new restoring point now" : "지금 새로운 복원 포인트의 생성을 요청합니다.",
    "The creation of a restoring point has been requested and will be initiated soon." : "복원 지점 생성이 요청되었으며, 곧 시작됩니다.",

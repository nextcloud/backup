OC.L10N.register(
    ...
    "hours" : "часове",
    "days" : "дни",
    "A new restoring point ({type}) have been generated, requiring maintenance mode for {downtime}." : "Генерирана е нова точка за възстановяване ({type}), която изисква режим на поддръжка за {downtime}.",
    ...
    "Path in which to store the restoring points. (Ex: 'backups')" : "Път, в който да се съхраняват точките за възстановяване. (Например: „резервни копия“)",
    ...
    "Create restoring points during the following time slot during the day:" : "Създайте точки за възстановяване през следния времеви интервал през деня:",
    "and" : "и",
    "Allow to create full restoring points during week day" : "Позволение за създадеване на пълни точки за възстановяване през седмичен ден",
    "Delay between two full restoring points" : "Забавяне между две точки на пълно възстановяване",
    "Delay between two partial restoring points" : "Забавяне между две точки за частично възстановяване",
    "Restoring point packing" : " Опаковане на точките за възстановяване",
    "Enable restoring point packing" : " Активиране на опаковане на точките за възстановяване",
    "Enable encryption" : "Активиране на криптирането",
    "Enable compression" : "Активиране на компресията",
    "Restoring point history" : "Възстановяване на историята на точките",
    "Number of restoring points to keep during a purge:" : "Брой точки за възстановяване, които да запазите по време на прочистване:",
    "In the local app data" : "В данните на локалното приложение",
    "In external storages" : "Във външни хранилища",
    "Schedule summary" : "Обобщение на графика",
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Пълна точка за възстановяване ще бъде създадена {delayFullRestoringPoint} дни след последната между {timeSlotsStart}:00 и {timeSlotsEnd}:00 всеки ден от седмицата.",
    ...
    "The creation of a restoring point as been requested and will be initiated soon." : "Създаването на точка за възстановяване, беше поискано и ще започне скоро.",

OC.L10N.register(
    ...
    "Your settings export has been downloaded encrypted. To be able to decrypt it later, please keep the following private key in a safe place:" : "您的設定匯出已下載並加密。要在之後可以解密，請將以下私鑰放在安全的地方：",
    "Request the creation of a new restoring point now" : "立刻請求建立一個新的還原點",
    "The creation of a restoring point has been requested and will be initiated soon." : "已請求建立還原點，並將很快就會啟動。",

OC.L10N.register(
    ...
    "Your settings export has been downloaded encrypted. To be able to decrypt it later, please keep the following private key in a safe place:" : "L'esportazione delle impostazioni è stata scaricata crittografata. Per poterla decriptare in seguito, conserva la seguente chiave privata in un posto sicuro:",
    "Request the creation of a new restoring point now" : "Richiedi ora la creazione di un nuovo punto di ripristino",
    "The creation of a restoring point has been requested and will be initiated soon." : "È stata richiesta la creazione di un punto di ripristino, che verrà avviata a breve.",
    ...
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._" : ["Verrà creato un punto di ripristino completo {delayFullRestoringPoint} giorno dopo l'ultimo {timeSlotsStart}:00 e {timeSlotsEnd}:00 qualsiasi giorno della settimana.","Verrà creato un punto di ripristino completo {delayFullRestoringPoint} giorni dopo l'ultimo {timeSlotsStart}:00 e {timeSlotsEnd}:00 qualsiasi giorno della settimana.","Verrà creato un punto di ripristino completo{delayFullRestoringPoint} giorni dopo l'ultimo {timeSlotsStart}:00 e {timeSlotsEnd}:00 qualsiasi giorno della settimana."],
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._" : ["Verrà creato un punto di ripristino completo {delayFullRestoringPoint} giorno dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 durante i fine settimana.","Verrà creato un punto di ripristino completo{delayFullRestoringPoint} giorni dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 durante i fine settimana.","Verrà creato un punto di ripristino completo {delayFullRestoringPoint} giorni dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}00 durante i fine settimana."],
    "_A partial restoring point will be created {delayPartialRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._::_A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._" : ["Verrà creato un punto di ripristino parziale {delayPartialRestoringPoint} giorno dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 qualsiasi giorno della settimana.","Verrà creato un punto di ripristino parziale {delayPartialRestoringPoint} giorni dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 qualsiasi giorno della settimana.","Verrà creato un punto di ripristino parziale {delayPartialRestoringPoint} giorni dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 qualsiasi giorno della settimana."],

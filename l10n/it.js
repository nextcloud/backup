OC.L10N.register(
    ...
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Verrà creato un punto di ripristino completo {delayFullRestoringPoint} giorni dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 in qualsiasi giorno della settimana.",
    "A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends." : "Verrà creato un punto di ripristino completo {delayFullRestoringPoint} giorni dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 durante i fine settimana.",
    "A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week." : "Verrà creato un punto di ripristino parziale {delayFullRestoringPoint} giorni dopo l'ultimo tra {timeSlotsStart}:00 e {timeSlotsEnd}:00 in qualsiasi giorno della settimana.",

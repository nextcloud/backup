OC.L10N.register(
    ...
    "Your settings export has been downloaded encrypted. To be able to decrypt it later, please keep the following private key in a safe place:" : "تم تنزيل إعدادات التصدير الخاصة بك مشفرة. لتتمكن من فك تشفيرها لاحقًا، يرجى الاحتفاظ بالمفتاح الخاص التالي في مكان آمن:",
    "Request the creation of a new restoring point now" : "أطلُب إنشاء نقطة استعادة جديدة الآن",
    "The creation of a restoring point has been requested and will be initiated soon." : "تم طلب إنشاء نقطة استعادة وسيتم البدء في ذلك حالاً.",
    ...
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._" : ["سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} يوم من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع."],
    "_A full restoring point will be created {delayFullRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._::_A full restoring point will be created {delayFullRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 during weekends._" : ["سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 خلال عطلات نهاية الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} يوم من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 خلال عطلات نهاية الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 خلال عطلات نهاية الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 خلال عطلات نهاية الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 خلال عطلات نهاية الأسبوع.","سوف يتم إنشاء نقطة استعادة كاملة بعد {delayFullRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 خلال عطلات نهاية الأسبوع."],
    "_A partial restoring point will be created {delayPartialRestoringPoint} day after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._::_A partial restoring point will be created {delayPartialRestoringPoint} days after the last one between {timeSlotsStart}:00 and {timeSlotsEnd}:00 any day of the week._" : ["سوف يتم إنشاء نقطة استعادة جزئية بعد {delayPartialRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة جزئية بعد {delayPartialRestoringPoint} يوم من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة جزئية بعد {delayPartialRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة جزئية بعد {delayPartialRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة جزئية بعد {delayPartialRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع.","سوف يتم إنشاء نقطة استعادة جزئية بعد {delayPartialRestoringPoint} أيام من آخر يوم بين {timeSlotsStart}: 00 و {timeSlotsEnd}: 00 في أي يوم من أيام الأسبوع."],

OC.L10N.register(
    ...
    "The Backup App creates and stores backup images of your Nextcloud:\n\n      - Backup the instance, its apps, your data and your database,\n      - Administrator can configure the time slots for automated backup,\n      - Full and Partial backup, with different frequencies,\n      - 2-pass to limit downtime (maintenance mode) of your instance,\n      - Compression and encryption,\n      - Upload your encrypted backup on an external filesystem,\n      - Download and search for your data,\n      - Restore single file or the entire instance." : "Backup aplikazioak zure Nextcloud-aren babeskopia irudiak sortzen eta gordetzen ditu:\n\n- Egin instantzia, bere aplikazioak, zure datuak eta zure datu-basearen babeskopia,\n- Administratzaileak babeskopia automatikorako denbora tarteak konfigura ditzake,\n- Babeskopia osoa eta partziala, maiztasun ezberdinekin,\n- 2. pasea zure instantziaren geldialdi-denbora (mantentze-modua) mugatzeko,\n- Konpresioa eta enkriptatzea,\n- Kargatu zure enkriptatutako babeskopia kanpoko fitxategi-sistema batean,\n- Deskargatu eta bilatu zure datuak,\n- Leheneratu fitxategi bakarra edo instantzia osoa.",
